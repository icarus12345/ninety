    ...
    try {
        ...
        $scope.export_and_open_pdf = function(project, export_option){
            ...
            try{
                ...
                ProjectService.get(project.id,function(p){
                    // check file exits 
                    var pdf_file_name = 'shark-tank-entrepreneur_'+p.info.alias;
        ...
        function _check_exits_pdf_file(_open_pdf, _export_pdf){
            window.resolveLocalFileSystemURL(
                ...
                function(){
                    Dialog.confirm({
                        title:'A PDF file already exists',
                        message:
                            'Do you want to open or export again?' + 
                            (device.platform == 'iOS'?'\nYou can open the PDF with iBook.':'')
                        ,
                        oktext:'Open',
                        canceltext:'Export',
                        ok: function(){
