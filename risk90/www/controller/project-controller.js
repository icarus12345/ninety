    ...
    try{
        ...
        ProjectService.get($routeParams.projectId,function(data){
            ...
            CategoryService.get($routeParams.categoryId,function(data){
                ...
                var total_height = window.innerHeight - 60 - 50 - elm.clientHeight;
                var item_height = Math.floor((window.innerHeight - 60 - 50 - item_length - elm.clientHeight) / item_length);
        ...
        Dialog.alert('Error when init Project Page.' + e.message);
    }
}
