...
// Toolbar groups configuration.
    ...
    config.stylesSet = 'default:' + base_url + 'lib/ckeditor/styles.js';
    config.filebrowserBrowseUrl = base_url + 'lib/kcfinder/browse.php?type=files';
    config.filebrowserImageBrowseUrl = base_url + 'lib/kcfinder/browse.php?type=image';
    config.filebrowserFlashBrowseUrl = base_url + 'lib/kcfinder/browse.php?type=flash';
    config.filebrowserUploadUrl = base_url + 'lib/kcfinder/upload.php?type=files';
    config.filebrowserImageUploadUrl = base_url + 'lib/kcfinder/upload.php?type=image';
    config.filebrowserFlashUploadUrl = base_url + 'lib/kcfinder/upload.php?type=flash';
