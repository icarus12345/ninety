                ...
                <div class="pull-bottom" style="position: relative;">
                    <div style="position: relative;padding-left: 58px">
                        ...
                        <div class="control-group">
                            <div class="input-append">
                                <input type="text" 
                                    ...
                                    id="<?php echo $id; ?>"
                                    value="<?php echo $value; ?>"
                                    onblur="$('#preview-cate-thumb<?php echo $id; ?>').css('background-image','url('+this.value+')')"
                                    >
                        ...
                        <div style="position: absolute;left: 0;top: 0;width: 48px;height: 48px;">
                            <div id="preview-cate-thumb<?php echo $id; ?>" 
    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane <?php echo $key==0?'active':''; ?>" id="entry-tab-<?php echo $key; ?>">
            ...
            <?php if($key==0) : ?>
                ...
                <?php if($entry_setting->data['typeviewer'] == 'list'): ?>
                <div class="col-xs-<?php echo $entry_setting->data['cateviewer'] == 'tree'?'6':'12'?> half">
                    <div class="pull-bottom">
                        <div>Type :</div>
                        <div class="control-group">
                            <div>
                                <select 
                                    name="tid" 
                                    class="form-control selectpicker "
                                    data-putto="#frm-err-data-type"
                                    data-live-search="true"
                                    data-size="10"
                                    >
                                    <option value="">[None]</option>
                                    <?php foreach($entry_setting->data['types'] as $t): ?>
                                        <option 
                                            value="<?php echo $t->id; ?>"
                                            <?php if ($t->id == $entry_detail->tid){echo 'selected="1"';} ?>
                                            ><?php echo $t->title; ?></span></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div id="frm-err-data-type"></div>
                        </div>
                    </div>
                </div>
                <?php elseif($entry_setting->data['typeviewer'] == 'string'): ?>
