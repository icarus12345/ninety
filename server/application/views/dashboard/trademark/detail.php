...
<div class="-modal-header pull-top pull-bottom">
    <h4>
       Trademark <small><?php echo $entry_detail?'Edit':'Add'; ?></small>
    </h4>
</div>
                    ...
                    <div class="control-group">
                        <div>
                            <select 
                                ...
                                data-putto="#frm-err-data-country_id"
                                data-live-search="true"
                                data-size="10"
                                data-server-dropdown="1"
                                >
                                <option value="">Nothing Selected</option>
                                <?php if(is_array($countries)) foreach($countries as $c): ?>
                                    <option 
                                        value="<?php echo $c->id; ?>"
                                        <?php if ($c->id == $entry_detail->country_id){echo 'selected="1"';} ?>
                                        ><?php echo $c->title; ?></span></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div id="frm-err-data-country_id"></div>
                    </div>
                </div>
            </div>
            <div class="col-xs-6 half">
                        ...
                        <div>
                            <select multiple
                                ...
                                <?php if(is_array($categories)) foreach($categories as $c): ?>
                                    <option 
                                        value="<?php echo $c->id; ?>"
                                        <?php if (in_array($c->id, $trademark_category_ids)){echo 'selected="1"';} ?>
                                        ><?php echo $c->title; ?></span></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
