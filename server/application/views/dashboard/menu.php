        ...
        <div class="secondary-box" >
            <div class="modal-header">
                ...
                <div class="modal-action">
                    <div><a href="JavaScript:App.Menu.ShowDetailDialog()" class="icon-plus" title="Add new entry"></a></div>
                    <div class="dropdown pull-right">
                        <a href="JavaScript:" class="icon-options-vertical" data-toggle="dropdown" title="Show more action"></a>
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                            <li><a href="JavaScript:App.Menu.ShowDetailDialog()"><span class="icon-plus"></span> Add New</a></li>
                            <li><a href="JavaScript:App.Menu.Refresh()"><span class="icon-refresh"></span> Refresh</a></li>
...
<script type="text/javascript">
    $(document).ready(function(){
        setTimeout(function(){
            App.Menu.sid = '<?php echo $sid; ?>';
            App.Menu.settings =  <?php echo json_encode($settings); ?>;
            App.Menu.Grid()
        }, 300)
    })
</script>