        ...
        <div class="about-us scroll-section">
            <div>
                ...
                <div class="how-we-work">
                    <h2 class="h2 wow fadeInUp text-center">OUR SERVICE</h2>
                        <div class="container">
                    <div class="our-service-box ">
                            ...
                            <div class="right">
                                <div>
                                    <div class="our-service-slider">
                                        <div class="owl-carousel" id="owl-our-service">
                                            <?php foreach($services as $item){ ?>
                                            <div class="item cover" style="background-image: url(<?php echo $item->data['image']; ?>)"></div>
                                            <?php } ?>
                                        </div>
                                    </div>
                                    <div class="list-service">
                                        <ul >
                                            <?php foreach($services as $item){ ?>
                                            <li><a href="JavaScript:"><?php echo $item->title; ?></a></li>
                                            <?php } ?>
                                        </ul>
                                    </div>
                                </div>
