...
class User extends Core_Controller {
    ...
    public function detail(){
        ...
        $companys = $this->Company_Model->gets();
    ...
    function bind(){
        ...
        $this->User_Model->table_config=array(
            ...
            "where"     => "WHERE ause_deleted is null AND ause_position >= $position",
            "order_by"  => "",
            "columnmaps"=>array(
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if($user_detail){
                if($user_detail->ause_position > $user->ause_position){
                    ...
                    if(gettype($params['ause_authority']) == 'array'){
